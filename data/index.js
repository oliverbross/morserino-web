document.addEventListener('DOMContentLoaded', () => {
    ...
    function getFallbackTarget(mode) {
        ...
        const targets = {
            ...
            codeGroups: ['ABC12', 'XYZ89', 'KLM45', 'QRS67', 'TNX73', 'FB599', 'CUL88', 'PSE', 'MSG', 'RPT'],
            callsigns: ['OM0RX', 'W1AW', 'K9LA', 'VE3ABC', 'G0XYZ', 'DL1QRS', 'JA1TNX', 'VK2DEF', 'S51MNO'],
            mixed: ['HELLO', 'ABC12', 'OM0RX', 'WORLD', 'XYZ89', 'W1AW', 'MORSE', 'KLM45', 'VE3ABC']
        };
